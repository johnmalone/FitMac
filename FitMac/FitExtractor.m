                ...
                case FIT_CONVERT_MESSAGE_AVAILABLE:
                {
                    ...
                    switch(mesg_num)
                    {
                        ...
                        case FIT_MESG_NUM_RECORD:
                        {
                            ...
                            printf(" Lat: %f", record->position_lat*(180/pow(2.0, 31.0)));
                            printf(" Long: %f", record->position_long*(180/pow(2.0, 31.0)));
                            printf(" HR: %u BPM", record->heart_rate);
                            printf(" Pwr: %u watts", record->power);
                            printf(" Spd: %0.2fkm/h", (record->speed/1000.0f) * 3.6);
                            printf(" Alt: %dm", (record->altitude /5 ) - 500);
                            printf(" Temp: %u C", record->temperature);

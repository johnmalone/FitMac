...
#define FIT_MANUFACTURER_COUNT                                                   95
...
class Profile
{
   public:
      ...
      typedef enum
      {
         MET_ZONE_MESG_FAT_CALORIES_FIELD_LOW_ALERT_ELEVATION,
         MET_ZONE_MESG_FAT_CALORIES_FIELD_HIGH_ALERT_ELEVATION,
         MET_ZONE_MESG_FAT_CALORIES_FIELD_SUBFIELDS,
         MET_ZONE_MESG_FAT_CALORIES_FIELD_ACTIVE_SUBFIELD = FIT_SUBFIELD_INDEX_ACTIVE_SUBFIELD,
         MET_ZONE_MESG_FAT_CALORIES_FIELD_MAIN_FIELD = FIT_SUBFIELD_INDEX_MAIN_FIELD
      } MET_ZONE_MESG_FAT_CALORIES_FIELD_SUBFIELD_INDEX;
